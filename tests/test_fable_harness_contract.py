...
def test_non_fable_summary_prompt_is_unchanged(summary_calls):
    _compressor(model="claude-sonnet-4-6")._generate_summary(_history()[1:5])
    prompt = summary_calls[0]["messages"][0]["content"]
