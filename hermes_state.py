...
class SessionDB(
    ...
    def __init__(
        ...
        *,
        ...
        self._conn = None
        # Transitional SQLite-primary dual-write mode (levos pg3 V1). This never changes the
        # read backend: it only captures committed SQLite write transactions and replays
        ...
        try:
            ...
            if read_only:
                ...
                if self._dual_mode:
                    ...
                    self._dual_replicator = DualWriteReplicator(self._conn, dual_write_dsn())
                    # The failure journal and coverage counters live only in the SQLite
