...
Write only the summary body. Do not include any preamble or prefix."""
    ...
    def _find_inflight_user_task(
        ...
        if include_media:
            # Fable rebase: image-bearing user turns count as the live task too.
            messages = [
                message for message in messages
                if not isinstance(message, dict)
                or message.get(_INFLIGHT_REPLAY_MERGED_KEY)
    ...
    def _finalize_compressed(
        ...
        if self._uses_fable_harness() and summary:
    ...
    def _uses_fable_harness(self) -> bool:
        from agent.anthropic_message_convert import _is_fable_model
    ...
    def compress(
        ...
        return self._finalize_compressed(compressed, messages, n_messages, summary)
